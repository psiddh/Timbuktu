...
public class activity_fragmentview extends FragmentActivity implements Animation.AnimationListener, View.OnTouchListener, map_fragmentview.Listener {
    private static final String TAG = "activity_fragmentview";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*mImgDisplay = (ImageView) findViewById(R.id.imgView);


        mImgDisplay.setImageURI(Uri.parse("/storage/emulated/0/DCIM/Camera/IMG_20140215_161830.jpg"));

        mImgDisplay.setOnTouchListener(this);*/
        // Set up an instance of SystemUiHider to control the system UI for
        // this activity.

        map_fragmentview fragment = (map_fragmentview) getSupportFragmentManager().findFragmentById(
                R.id.mapFragment);
    ...
    public void onItemSelected(String link) {
        slider_fragmentview fragment = (slider_fragmentview) getFragmentManager().findFragmentById(
                R.id.sliderFragment);
